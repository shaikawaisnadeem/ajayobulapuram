...
const Hero = () => {
  return (
    <header className="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden px-margin-page z-10">
      <div className="relative z-10 grid md:grid-cols-2 gap-12 max-w-container-max mx-auto items-center">
        <RevealOnScroll>
